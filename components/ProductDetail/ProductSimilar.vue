<template>
  <div class="columns is-multiline p-2">
    <div class="column is-12">
      <div class="columns">
        <div class="column is-2 p-2 showcase-title">Benzer Urunler</div>
        <div class="column is-10 p-2" align="right">
          <a @click="activeslide--"
            ><img class="pl-2" src="@/assets/detail/slide_prev.png"
          /></a>
          <a @click="activeslide++"
            ><img class="pl-2" src="@/assets/detail/slide_next.png"
          /></a>
        </div>
      </div>
      ...
      <b-carousel-list
        v-model="activeslide"
        :data="productDetails.similarProducts"
        :items-to-show="4"
        :arrow="false"
      >
          ...
          <a class="">
            <div class="columns is-multiline carditem">
              ...
              <div class="column is-12">
                ...
                <div class="column is-12 cardprice">
                  {{ item.price }} TL <span class="kdv"> + KDV</span>
                </div>
