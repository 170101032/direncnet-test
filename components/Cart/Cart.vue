      ...
      <div class="column is-12">
        <table class="column is-12 table-box">
          ...
          <tr class="columns" v-for="(item, i) in cart" :key="i">
            ...
            <td class="column is-2 p-2">
              <div class="column is-12 table-box p-4">
                ...
                <a
                  ...
                  class="table-box p-2 px-3 ml-4 mr-1 downquan"
                  >-</a
                >
                {{ item.quantity }}
                <a
                  @click="item.quantity++"
                  class="table-box p-2 px-3 mx-1 upquan"
                  >+</a
                >
              </div>
            </td>
            <td class="column is-2 table-bold p-2">
            ...
            <td class="column is-1 p-2">
              <a @click="removeCart(item)" class="cart-cross p-1"
      ...
      <div class="column is-12" align="right">
        <div class="column is-12" align="left">
          <div class="column is-8">
            ...
            <NuxtLink to="/" class="cart-link p-1 mr-1"
              >Alisverise Devam</NuxtLink
            >
